...
dependency: []
type: "task"
write-id: "1788075097891-0.0r466cotf3jpu7u5e45"
points: "3"
...
CodeRabbit exact-head review on PR #312 predecessor 1281c728a930667a05baa253bbb77894fd11ccc3 produced four threads. Two were false under repository authority and were evidence-resolved: historical task-created ledger bytes are append-only and later dependency frontmatter event 3147 reconstructs []; the final card delimiter is Rheos's canonical comment serializer shape. Two were valid and are repaired locally: CLI docs now name EDN :card-dirs, and dependency IDs share the line-safe card UUID grammar so quotes/newlines cannot alter serialized frontmatter. RED prior law accepted quote/newline injection; GREEN tests cover law, create, MCP schema patterns, and byte-identical update refusal. Exact local candidate: Rheos 180 tests / 913 assertions, 0 failures; compile 0 warnings; clj-kondo 0 errors / 0 warnings; server, cli, github-sync, and app release builds 0 warnings; diff check clean. Successor publication, exact hosted gates, independent review, and merge remain pending.
---