...
Tools are loaded via jiti. They can import any 3rd party dependencies (install in the tool directory). Imports of `@open-hax/eta-mu-ai` and `@mariozechner/pi-mom` are aliased to the running mom bundle.
