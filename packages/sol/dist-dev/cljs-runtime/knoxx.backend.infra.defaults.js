...
goog.provide('knoxx.backend.infra.defaults');
knoxx.backend.infra.defaults.default_model = (function knoxx$backend$infra$defaults$default_model(config){
var or__5162__auto__ = new cljs.core.Keyword(null,"proxx-default-model","proxx-default-model",-927829764).cljs$core$IFn$_invoke$arity$1(config);
