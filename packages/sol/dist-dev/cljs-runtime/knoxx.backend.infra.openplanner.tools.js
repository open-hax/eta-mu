...
return knoxx.backend.domain.text.tool_text_result((""+"Read URL "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(url)+" ("+cljs.core.str.cljs$core$IFn$_invoke$arity$1(content_type)+"):\n\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(clipped)),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"url","url",276297046),url,new cljs.core.Keyword(null,"contentType","contentType",-1462509576),content_type,new cljs.core.Keyword(null,"text","text",-1790561697),clipped], null));
} else {
return knoxx.backend.domain.text.tool_text_result((""+"Fetched URL "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(url)+" with content-type "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(content_type)+". Binary/image content is available at the URL for follow-up use."),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"url","url",276297046),url,new cljs.core.Keyword(null,"contentType","contentType",-1462509576),content_type,new cljs.core.Keyword(null,"binary","binary",-1802232288),true], null));
}
}
});
knoxx.backend.infra.openplanner.tools.slugify = (function knoxx$backend$infra$openplanner$tools$slugify(value){
var raw = clojure.string.replace(clojure.string.replace(clojure.string.lower_case((""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__5162__auto__ = value;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
knoxx.backend.infra.openplanner.tools.make_memory_search_execute = (function knoxx$backend$infra$openplanner$tools$make_memory_search_execute(auth_context){
return (async function (_runtime,config,_tool_call_id,params,a,b,c){
...
var k = (params["k"]);
var session_id = (await (async function (){var or__5162__auto__ = (params["sessionId"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return "";
...
knoxx.backend.domain.tools.maybe_tool_update_BANG_(on_update,"Searching Knoxx memory in OpenPlanner\u2026");
...
return knoxx.backend.domain.text.tool_text_result(knoxx.backend.domain.text.openplanner_memory_search_text(filtered),filtered);
});
});
knoxx.backend.infra.openplanner.tools.make_memory_session_execute = (function knoxx$backend$infra$openplanner$tools$make_memory_session_execute(auth_context){
return (async function (_runtime,config,_tool_call_id,params,a,b,c){
var on_update = (await (async function (){var or__5162__auto__ = ((cljs.core.fn_QMARK_(a))?a:null);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
...
knoxx.backend.domain.tools.maybe_tool_update_BANG_(on_update,"Loading Knoxx session from OpenPlanner\u2026");

var rows = (await knoxx.backend.infra.core_memory.fetch_openplanner_session_rows_BANG_(config,session_id));
if(knoxx.backend.infra.core_memory.session_visible_QMARK_(auth_context,rows)){
} else {
throw knoxx.backend.infra.http.http_error((403),"memory_scope_denied","OpenPlanner session is outside the current Knoxx scope");
}

var payload = (await (async function (){var G__28061 = ({});
(G__28061["sessionId"] = session_id);

(G__28061["rows"] = cljs.core.clj__GT_js(rows));

return G__28061;
})());
return knoxx.backend.domain.text.tool_text_result(knoxx.backend.domain.text.openplanner_session_text(session_id,rows),payload);
});
});
knoxx.backend.infra.openplanner.tools.graph_query_execute = (async function knoxx$backend$infra$openplanner$tools$graph_query_execute(_runtime,config,_tool_call_id,params,a,b,c){
var on_update = (await (async function (){var or__5162__auto__ = ((cljs.core.fn_QMARK_(a))?a:null);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
var lake = (await (async function (){var or__5162__auto__ = (params["lake"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return "";
...
var node_type = (await (async function (){var or__5162__auto__ = (params["nodeType"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return "";
...
knoxx.backend.domain.tools.maybe_tool_update_BANG_(on_update,"Querying canonical knowledge graph\u2026");

var result = (await knoxx.backend.infra.openplanner.memory.openplanner_graph_query_BANG_(config,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"query","query",-1288509510),query,new cljs.core.Keyword(null,"lake","lake",805586599),lake,new cljs.core.Keyword(null,"node-type","node-type",129492462),node_type,new cljs.core.Keyword(null,"limit","limit",-1355822363),limit,new cljs.core.Keyword(null,"edge-limit","edge-limit",4816756),edge_limit], null)));
return knoxx.backend.domain.text.tool_text_result(knoxx.backend.domain.text.graph_query_result_text(result),result);
});
knoxx.backend.infra.openplanner.tools.websearch_execute = (async function knoxx$backend$infra$openplanner$tools$websearch_execute(_runtime,config,_tool_call_id,params,a,b,c){
var on_update = (await (async function (){var or__5162__auto__ = ((cljs.core.fn_QMARK_(a))?a:null);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
var num_results = (await (async function (){var or__5162__auto__ = (params["numResults"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return (8);
...
var allowed_domains = (await (async function (){var or__5162__auto__ = (params["allowedDomains"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
knoxx.backend.domain.tools.maybe_tool_update_BANG_(on_update,"Searching the live web through Proxx\u2026");

var resp = (await knoxx.backend.infra.clients.proxx.websearch_BANG_(knoxx.backend.infra.clients.proxx.client.cljs$core$IFn$_invoke$arity$1(config),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"query","query",-1288509510),query,new cljs.core.Keyword(null,"numResults","numResults",-2106407448),num_results,new cljs.core.Keyword(null,"searchContextSize","searchContextSize",1024145239),search_context_size,new cljs.core.Keyword(null,"allowedDomains","allowedDomains",975388721),allowed_domains,new cljs.core.Keyword(null,"model","model",331153215),model], null)));
if(cljs.core.truth_(new cljs.core.Keyword(null,"ok","ok",967785236).cljs$core$IFn$_invoke$arity$1(resp))){
return knoxx.backend.domain.text.tool_text_result(knoxx.backend.domain.text.websearch_result_text(new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(resp)),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(resp));
} else {
throw (new Error((""+"websearch failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(resp)], 0))))));
}
});
knoxx.backend.infra.openplanner.tools.web_read_execute = (function knoxx$backend$infra$openplanner$tools$web_read_execute(_runtime,_config,_tool_call_id,params,a,b,c){
...
var url = (function (){var or__5162__auto__ = (params["url"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return "";
...
var max_chars = cljs.core.max.cljs$core$IFn$_invoke$arity$2((200),cljs.core.min.cljs$core$IFn$_invoke$arity$2((20000),(function (){var or__5162__auto__ = (params["maxChars"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return (6000);
...
knoxx.backend.domain.tools.maybe_tool_update_BANG_(on_update,(""+"Fetching "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(url)+"\u2026"));

return knoxx.backend.infra.openplanner.tools.web_read_url_BANG_(url,max_chars);
});
knoxx.backend.infra.openplanner.tools.make_create_new_file_execute = (function knoxx$backend$infra$openplanner$tools$make_create_new_file_execute(auth_context){
return (async function (runtime,config,_tool_call_id,params,a,b,c){
var on_update = (await (async function (){var or__5162__auto__ = ((cljs.core.fn_QMARK_(a))?a:null);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
var title = (await (async function (){var or__5162__auto__ = (params["title"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return "Untitled Canvas";
...
var requested_path = (await (async function (){var or__5162__auto__ = (params["path"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return (""+"notes/canvas/"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(knoxx.backend.infra.openplanner.tools.slugify(title))+".md");
}
})());
...
var profile = knoxx.backend.infra.document_state.active_agent_profile.cljs$core$IFn$_invoke$arity$3(runtime,config,auth_context);
var docs_path = new cljs.core.Keyword(null,"docsPath","docsPath",-1515329882).cljs$core$IFn$_invoke$arity$1(profile);
var rel_path = knoxx.backend.infra.document_state.normalize_relative_path(requested_path);
var abs_path = knoxx.backend.domain.media.path_resolve.cljs$core$IFn$_invoke$arity$variadic(shadow.esm.esm_import$node_path,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([docs_path,rel_path], 0));
var rel_to_root = knoxx.backend.domain.media.path_relative(shadow.esm.esm_import$node_path,docs_path,abs_path);
...
return knoxx.backend.domain.media.path_is_absolute_QMARK_(shadow.esm.esm_import$node_path,rel_to_root);
}
})()))){
...
knoxx.backend.domain.tools.maybe_tool_update_BANG_(on_update,(""+"Creating canvas file "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(rel_path)+"\u2026"));

(await knoxx.backend.domain.media.fs_mkdir_BANG_(shadow.esm.esm_import$node_fs$promises,parent,({"recursive": true})));

(await knoxx.backend.domain.media.fs_write_file_BANG_.cljs$core$IFn$_invoke$arity$4(shadow.esm.esm_import$node_fs$promises,abs_path,content,"utf8"));

return knoxx.backend.domain.text.tool_text_result((""+"Created canvas file at "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(rel_path)),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"path","path",-188191168),rel_path,new cljs.core.Keyword(null,"title","title",636505583),title,new cljs.core.Keyword(null,"content","content",15833224),content,new cljs.core.Keyword(null,"canvas","canvas",-1798817489),true], null));
});
});
knoxx.backend.infra.openplanner.tools.make_push_claim_execute = (function knoxx$backend$infra$openplanner$tools$make_push_claim_execute(auth_context){
return (async function (runtime,config,_tool_call_id,params,a,b,c){
var on_update = (await (async function (){var or__5162__auto__ = ((cljs.core.fn_QMARK_(a))?a:null);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
...
var evidence = (await (async function (){var or__5162__auto__ = (params["evidence"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return [];
...
var p = (await (async function (){var or__5162__auto__ = (params["probability"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return 0.5;
...
var profile = knoxx.backend.infra.document_state.active_agent_profile.cljs$core$IFn$_invoke$arity$3(runtime,config,auth_context);
var event = knoxx.backend.infra.openplanner.memory.openplanner_event(config,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"id","id",-1388402092),(""+"claim:"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(crypto.randomUUID())),new cljs.core.Keyword(null,"kind","kind",-717265803),"knoxx.claim",new cljs.core.Keyword(null,"session","session",1008279103),new cljs.core.Keyword(null,"sessionId","sessionId",1640410629).cljs$core$IFn$_invoke$arity$1(auth_context),new cljs.core.Keyword(null,"role","role",-736691072),"assistant",new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"model","model",331153215).cljs$core$IFn$_invoke$arity$1(profile),new cljs.core.Keyword(null,"text","text",-1790561697),claim,new cljs.core.Keyword(null,"extra","extra",1612569067),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"claim","claim",-975359169),claim,new cljs.core.Keyword(null,"evidence","evidence",1765855722),cljs.core.clj__GT_js(evidence),new cljs.core.Keyword(null,"p","p",151049309),p,new cljs.core.Keyword(null,"src","src",-1651076051),source], null)], null));
knoxx.backend.domain.tools.maybe_tool_update_BANG_(on_update,(""+"Pushing claim to graph: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(claim)+"\u2026"));

var resp = (await knoxx.backend.infra.clients.openplanner.events_BANG_(knoxx.backend.infra.clients.openplanner.client.cljs$core$IFn$_invoke$arity$1(config),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [event], null)));
return knoxx.backend.domain.text.tool_text_result((""+"Successfully pushed claim to graph: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(claim)),resp);
});
});
knoxx.backend.infra.openplanner.tools.make_save_translation_execute = (function knoxx$backend$infra$openplanner$tools$make_save_translation_execute(auth_context){
return (async function (_runtime,config,_tool_call_id,params,a,b,c){
var on_update = (await (async function (){var or__5162__auto__ = ((cljs.core.fn_QMARK_(a))?a:null);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
...
var source_lang = (await (async function (){var or__5162__auto__ = (params["source_lang"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
var or__5162__auto____$1 = new cljs.core.Keyword(null,"source_lang","source_lang",-931946297).cljs$core$IFn$_invoke$arity$1(resource_policies);
if(cljs.core.truth_(or__5162__auto____$1)){
return or__5162__auto____$1;
} else {
...
var target_lang = (await (async function (){var or__5162__auto__ = (params["target_lang"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
var or__5162__auto____$1 = new cljs.core.Keyword(null,"target_lang","target_lang",220363042).cljs$core$IFn$_invoke$arity$1(resource_policies);
if(cljs.core.truth_(or__5162__auto____$1)){
return or__5162__auto____$1;
} else {
...
var document_id = (await (async function (){var or__5162__auto__ = (params["document_id"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
var or__5162__auto____$1 = new cljs.core.Keyword(null,"document_id","document_id",-1715671349).cljs$core$IFn$_invoke$arity$1(resource_policies);
if(cljs.core.truth_(or__5162__auto____$1)){
return or__5162__auto____$1;
} else {
...
var garden_id = (await (async function (){var or__5162__auto__ = (params["garden_id"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
var or__5162__auto____$1 = new cljs.core.Keyword(null,"garden_id","garden_id",1092752211).cljs$core$IFn$_invoke$arity$1(resource_policies);
if(cljs.core.truth_(or__5162__auto____$1)){
return or__5162__auto____$1;
} else {
...
var project = (await (async function (){var or__5162__auto__ = (params["project"]);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
var or__5162__auto____$1 = new cljs.core.Keyword(null,"project","project",1124394579).cljs$core$IFn$_invoke$arity$1(resource_policies);
if(cljs.core.truth_(or__5162__auto____$1)){
return or__5162__auto____$1;
} else {
...
var normalized_source = clojure.string.trim((""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((await (async function (){var or__5162__auto__ = source_text;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return "";
...
var normalized_translated = clojure.string.trim((""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((await (async function (){var or__5162__auto__ = translated_text;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return "";
...
var _ = (((((!(clojure.string.blank_QMARK_(source_lang)))) && ((((!(clojure.string.blank_QMARK_(target_lang)))) && (((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(source_lang,target_lang)) && (((prose_like_QMARK_) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(normalized_source,normalized_translated))))))))))?(await (async function (){throw (new Error((""+"translated_text matches source_text for segment "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(segment_index)+"; provide an actual "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(target_lang)+" translation")))})()):null);
var ___$1 = ((clojure.string.blank_QMARK_((""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(document_id))))?(await (async function (){throw (new Error("document_id is required for save_translation"))})()):null);
...
knoxx.backend.domain.tools.maybe_tool_update_BANG_(on_update,(""+"Saving translation segment "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(segment_index)+"\u2026"));

var result = (await knoxx.backend.infra.clients.openplanner.create_translation_segment_BANG_(knoxx.backend.infra.clients.openplanner.client.cljs$core$IFn$_invoke$arity$1(config),segment));
return knoxx.backend.domain.text.tool_text_result((""+"Saved segment "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(segment_index)+": "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(translated_text.substring((0),cljs.core.min.cljs$core$IFn$_invoke$arity$2((50),cljs.core.count(translated_text))))+"\u2026"),result);
});
});
knoxx.backend.infra.openplanner.tools.graph_query_tool = cljs.core.partial.cljs$core$IFn$_invoke$arity$variadic(knoxx.backend.domain.tools.create_tool_obj,"graph_query","Graph Query","Query the canonical OpenPlanner knowledge graph across the workspace, web, bluesky, and knoxx-session lakes.",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Search the canonical knowledge graph when you need entities or cross-lake links rather than plain transcript memory or semantic document snippets.",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Use graph_query when the question is about entities, paths, URLs, provenance across lakes, or graph connectivity.","Prefer graph_query over semantic_query when node/edge structure matters.","Use the lake filter to focus on workspace, web, bluesky, or knoxx-session when the search space is obvious."], null),knoxx.backend.infra.openplanner.tools.graph_query_params,knoxx.backend.infra.openplanner.tools.graph_query_execute], 0));
knoxx.backend.infra.openplanner.tools.websearch_tool = cljs.core.partial.cljs$core$IFn$_invoke$arity$variadic(knoxx.backend.domain.tools.create_tool_obj,"websearch","Web Search","Search the live web through Proxx websearch and return cited results.",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Search the live web when the user needs fresh external information or wants to expand the web frontier.",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Use websearch when freshness matters or when the answer probably lives outside the current graph corpus.","Prefer allowedDomains when you know the likely source surface.","Use websearch to seed follow-up graph or semantic exploration, not as a substitute for graph_query when graph structure already exists."], null),knoxx.backend.infra.openplanner.tools.websearch_params,knoxx.backend.infra.openplanner.tools.websearch_execute], 0));
knoxx.backend.infra.openplanner.tools.web_read_tool = cljs.core.partial.cljs$core$IFn$_invoke$arity$variadic(knoxx.backend.domain.tools.create_tool_obj,"web.read","Web Read","Fetch a web link or attachment URL and extract readable text or metadata.",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Read a web page, text attachment, or direct file URL when you already have a concrete link.",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Use web.read for direct URLs from Discord messages, embeds, or attachments.","For image/binary URLs, web.read returns metadata so you can decide whether to forward the attachment or inspect it another way."], null),knoxx.backend.infra.openplanner.tools.web_read_params,knoxx.backend.infra.openplanner.tools.web_read_execute], 0));
knoxx.backend.infra.openplanner.tools.memory_search_tool = (function knoxx$backend$infra$openplanner$tools$memory_search_tool(auth_context){
return cljs.core.partial.cljs$core$IFn$_invoke$arity$variadic(knoxx.backend.domain.tools.create_tool_obj,"memory_search","Memory Search","Search prior Knoxx sessions, answers, and tool/action receipts stored in OpenPlanner.",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Search Knoxx long-term memory in OpenPlanner when the user asks about earlier sessions, prior decisions, or the agent's own past actions.",new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Use memory_search when the user references previous sessions, past work, or asks you to remember what happened before.","Prefer memory_search over guessing about prior conversations or actions.","Reasoning traces are filtered out of memory_search by default; use memory_session only when exact transcript drill-down is required.","If one session looks relevant, follow with memory_session to inspect the full transcript slice."], null),knoxx.backend.infra.openplanner.tools.memory_search_params,knoxx.backend.infra.openplanner.tools.make_memory_search_execute(auth_context)], 0));
});
knoxx.backend.infra.openplanner.tools.memory_session_tool = (function knoxx$backend$infra$openplanner$tools$memory_session_tool(auth_context){
return cljs.core.partial.cljs$core$IFn$_invoke$arity$variadic(knoxx.backend.domain.tools.create_tool_obj,"memory_session","Memory Session","Load the indexed transcript/events for a specific Knoxx session from OpenPlanner.",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Load a specific Knoxx OpenPlanner session when you need the exact previous transcript or action trace.",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Use memory_session after memory_search identifies a promising session id.","memory_session is the exact transcript/action drill-down companion to memory_search."], null),knoxx.backend.infra.openplanner.tools.memory_session_params,knoxx.backend.infra.openplanner.tools.make_memory_session_execute(auth_context)], 0));
});
knoxx.backend.infra.openplanner.tools.save_translation_tool = (function knoxx$backend$infra$openplanner$tools$save_translation_tool(auth_context){
return cljs.core.partial.cljs$core$IFn$_invoke$arity$variadic(knoxx.backend.domain.tools.create_tool_obj,"save_translation","Save Translation","Save a translated segment to the OpenPlanner translation database.",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Save each translated segment after translating.",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Call save_translation for each segment you translate.","Include the source_text, translated_text, language codes, document_id, and segment_index."], null),knoxx.backend.infra.openplanner.tools.translation_params,knoxx.backend.infra.openplanner.tools.make_save_translation_execute(auth_context)], 0));
});
knoxx.backend.infra.openplanner.tools.create_new_file_tool = (function knoxx$backend$infra$openplanner$tools$create_new_file_tool(auth_context){
return cljs.core.partial.cljs$core$IFn$_invoke$arity$variadic(knoxx.backend.domain.tools.create_tool_obj,"create_new_file","Create New File","Create a new file-backed artifact for the Knoxx canvas editor.",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Create a new concrete artifact file when the user is ready to draft a real document instead of continuing in freeform chat.",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Use create_new_file when the user wants to start an actual artifact or canvas-backed document.","Return a file path and initial markdown content so the chat canvas can open it immediately."], null),knoxx.backend.infra.openplanner.tools.create_file_params,knoxx.backend.infra.openplanner.tools.make_create_new_file_execute(auth_context)], 0));
});
knoxx.backend.infra.openplanner.tools.push_claim_tool = (function knoxx$backend$infra$openplanner$tools$push_claim_tool(auth_context){
return cljs.core.partial.cljs$core$IFn$_invoke$arity$variadic(knoxx.backend.domain.tools.create_tool_obj,"push_claim","Push Claim","Add a new claim or proposition to the knowledge graph. Use this when you discover a fact or derive an inference during an investigation.",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Push a discovered claim or derived inference into the knowledge graph. Treat the graph as an evolving tapestry of hypotheses; the act of recording a discovery is as valuable as the discovery itself.",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Use push_claim when you uncover a new fact or derive a logical inference during investigation.","Don't obsess over binary truth; prioritize the capture of the epistemic trail.","Include all relevant evidence and a confidence probability."], null),knoxx.backend.infra.openplanner.tools.push_claim_params,knoxx.backend.infra.openplanner.tools.make_push_claim_execute(auth_context)], 0));
});
knoxx.backend.infra.openplanner.tools.create_openplanner_custom_tools = (function knoxx$backend$infra$openplanner$tools$create_openplanner_custom_tools(var_args){
var G__28179 = arguments.length;
switch (G__28179) {
case 2:
return knoxx.backend.infra.openplanner.tools.create_openplanner_custom_tools.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));

break;
case 3:
return knoxx.backend.infra.openplanner.tools.create_openplanner_custom_tools.cljs$core$IFn$_invoke$arity$3((arguments[(0)]),(arguments[(1)]),(arguments[(2)]));
...
(knoxx.backend.infra.openplanner.tools.create_openplanner_custom_tools.cljs$core$IFn$_invoke$arity$2 = (function (runtime,config){
return knoxx.backend.infra.openplanner.tools.create_openplanner_custom_tools.cljs$core$IFn$_invoke$arity$3(runtime,config,null);
}));

(knoxx.backend.infra.openplanner.tools.create_openplanner_custom_tools.cljs$core$IFn$_invoke$arity$3 = (function (runtime,config,auth_context){
return cljs.core.clj__GT_js(cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((((auth_context == null)) || (((knoxx.backend.infra.auth.authz.ctx_tool_allowed_QMARK_(auth_context,"graph_query")) || (knoxx.backend.infra.auth.authz.ctx_tool_allowed_QMARK_(auth_context,"semantic_query"))))))?knoxx.backend.infra.openplanner.tools.graph_query_tool(runtime,config):null),(((((auth_context == null)) || (knoxx.backend.infra.auth.authz.ctx_tool_allowed_QMARK_(auth_context,"websearch"))))?knoxx.backend.infra.openplanner.tools.websearch_tool(runtime,config):null),(((((auth_context == null)) || (knoxx.backend.infra.auth.authz.ctx_tool_allowed_QMARK_(auth_context,"web.read"))))?knoxx.backend.infra.openplanner.tools.web_read_tool(runtime,config):null),(((((auth_context == null)) || (knoxx.backend.infra.auth.authz.ctx_tool_allowed_QMARK_(auth_context,"memory_search"))))?knoxx.backend.infra.openplanner.tools.memory_search_tool(auth_context)(runtime,config):null),(((((auth_context == null)) || (knoxx.backend.infra.auth.authz.ctx_tool_allowed_QMARK_(auth_context,"memory_session"))))?knoxx.backend.infra.openplanner.tools.memory_session_tool(auth_context)(runtime,config):null),(((((auth_context == null)) || (knoxx.backend.infra.auth.authz.ctx_tool_allowed_QMARK_(auth_context,"save_translation"))))?knoxx.backend.infra.openplanner.tools.save_translation_tool(auth_context)(runtime,config):null),(((((auth_context == null)) || (knoxx.backend.infra.auth.authz.ctx_tool_allowed_QMARK_(auth_context,"create_new_file"))))?knoxx.backend.infra.openplanner.tools.create_new_file_tool(auth_context)(runtime,config):null),(((((auth_context == null)) || (knoxx.backend.infra.auth.authz.ctx_tool_allowed_QMARK_(auth_context,"push_claim"))))?knoxx.backend.infra.openplanner.tools.push_claim_tool(auth_context)(runtime,config):null)], null))));
}));

(knoxx.backend.infra.openplanner.tools.create_openplanner_custom_tools.cljs$lang$maxFixedArity = 3);


//# sourceMappingURL=knoxx.backend.infra.openplanner.tools.js.map
