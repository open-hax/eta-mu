...
if((typeof knoxx !== 'undefined') && (typeof knoxx.backend !== 'undefined') && (typeof knoxx.backend.runtime !== 'undefined') && (typeof knoxx.backend.runtime.state !== 'undefined') && (typeof knoxx.backend.runtime.state.policy_context_STAR_ !== 'undefined')){
} else {
knoxx.backend.runtime.state.policy_context_STAR_ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
}
knoxx.backend.runtime.state.remember_context_BANG_ = (function knoxx$backend$runtime$state$remember_context_BANG_(runtime,config,policy_context){
...
cljs.core.reset_BANG_(knoxx.backend.runtime.state.policy_context_STAR_,policy_context);

return true;
});
knoxx.backend.runtime.state.current_policy_db = (function knoxx$backend$runtime$state$current_policy_db(){
return cljs.core.deref(knoxx.backend.runtime.state.policy_context_STAR_);
});
