...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_17552 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_17552(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_17574 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_17574(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_17593 = (function (reader,ch){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_17593(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_17615 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_17615(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_17626 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_17626(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_17643 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_17643(reader);
}
});
...
var G__18157 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__18158 = s.append(c);
c = G__18157;
s = G__18158;
continue;
}
