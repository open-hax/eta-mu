(ns open-hax.sol.domain.agent.content
  "Content-part, media, and text helpers for agent turns."
  (:require [clojure.string :as str]
            [open-hax.sol.domain.agent.text-delta :as text-delta]
            [open-hax.sol.domain.models :refer [model-supports-input?]]
            [open-hax.sol.domain.text :refer [value->preview-text content-part-text]]))
