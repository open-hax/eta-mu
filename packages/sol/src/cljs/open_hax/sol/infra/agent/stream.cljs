(ns open-hax.sol.infra.agent.stream
  ...
  (:require [clojure.string :as str]
            ...
            [open-hax.sol.infra.agent.stream.provider-events :as provider-events]
            [open-hax.sol.infra.agent.stream.sinks :as sinks]
            [open-hax.sol.infra.agent.tools :refer [tool-call-preview-from-part assistant-tool-call-previews]]
            [open-hax.sol.domain.action.run-state :refer [append-limited tool-event-payload]]
            [open-hax.sol.domain.text :refer [assistant-message-text assistant-message-reasoning-text]]
            [open-hax.sol.domain.voice.turn-control :as turn-control]
