(ns eta-mu.gate.contract-law-test
  "Tests for the output contract gate Malli schemas in eta-mu.gate.law.contract.
  ...
  (:require [cljs.test :refer [deftest is testing]]
            [clojure.edn :as edn]
            [eta-mu.gate.law.contract :as law]
            [malli.core :as m]))
...
(deftest schema-registry-test
  (testing "qualified keyword registry contains every exported schema"
    ...
    (is (every? #(conforming? (get law/schema-registry %) (get {:eta-mu.gate.law.contract/contract-section (first fixture-sections)
                                                                 :eta-mu.gate.law.contract/contract-rule (first fixture-rules)
                                                                 :eta-mu.gate.law.contract/repair-template (first fixture-repair-templates)
                                                                 :eta-mu.gate.law.contract/review-criterion (first (:criteria fixture-review-policy))
                                                                 :eta-mu.gate.law.contract/review-criterion-score (first (:criteria fixture-review-report))
                                                                 :eta-mu.gate.law.contract/review-policy fixture-review-policy
                                                                 :eta-mu.gate.law.contract/arbitration-form (first fixture-arbitration)
                                                                 :eta-mu.gate.law.contract/normalized-contract fixture-normalized-contract
                                                                 :eta-mu.gate.law.contract/markdown-node {:type "text"}
                                                                 :eta-mu.gate.law.contract/markdown-root fixture-valid-markdown-root
                                                                 :eta-mu.gate.law.contract/extracted-section (first (:sections fixture-extracted-document))
                                                                 :eta-mu.gate.law.contract/extracted-document fixture-extracted-document
                                                                 :eta-mu.gate.law.contract/validation-failure (first (:failures fixture-failure-report))
                                                                 :eta-mu.gate.law.contract/validation-result fixture-validation-result
                                                                 :eta-mu.gate.law.contract/failure-report fixture-failure-report
                                                                 :eta-mu.gate.law.contract/artifact-bundle fixture-artifact-bundle
                                                                 :eta-mu.gate.law.contract/review-report fixture-review-report
                                                                 :eta-mu.gate.law.contract/gpt-review-config fixture-gpt-review-config
                                                                 :eta-mu.gate.law.contract/gpt-review-message {:role :user :content "hi"}
                                                                 :eta-mu.gate.law.contract/generation-mode :fixture-valid
                                                                 :eta-mu.gate.law.contract/generation-report fixture-generation-report
                                                                 :eta-mu.gate.law.contract/repair-attempt-record fixture-repair-attempt-record}
                                                                %))
