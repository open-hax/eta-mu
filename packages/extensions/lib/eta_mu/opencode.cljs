(ns ^{:clj-kondo/ignore [:promise-chain/prefer-async-workflow]} eta-mu.opencode
...
;; NOTE: This file intentionally builds sequential promise chains for OpenCode
;; hook compatibility. The chain style is required because some hook contracts
;; expect synchronous registration and side-effectful mutation of the output
;; object; switching to `^:async` would change the returned value/promise shape.
;; The :promise-chain/prefer-async-workflow rule is therefore ignored here.
