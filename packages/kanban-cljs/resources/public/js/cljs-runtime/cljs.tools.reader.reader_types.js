...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_8160 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_8160(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_8162 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_8162(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_8164 = (function (reader,ch){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_8164(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_8167 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_8167(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_8168 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_8168(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_8174 = (function (reader){
var x__5519__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_8174(reader);
}
});
...
var G__8202 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__8203 = s.append(c);
c = G__8202;
s = G__8203;
continue;
}
