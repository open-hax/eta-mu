...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__8404_SHARP_,p2__8403_SHARP_){
return p2__8403_SHARP_.toUpperCase();
}));
...
var G__8419 = o;
helix.impl.props.goog$module$goog$object.set(G__8419,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__8493 = cljs.core.rest(m);
var G__8494 = (function (){var entry = cljs.core.first(m);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8465_SHARP_){
if(cljs.core.map_QMARK_(p1__8465_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__8465_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__8498 = cljs.core.rest(m);
var G__8499 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
var G__8474 = k;
var G__8474__$1 = (((G__8474 instanceof cljs.core.Keyword))?G__8474.fqn:null);
switch (G__8474__$1) {
case "class":
...
while(true){
if(cljs.core.seq(m)){
var G__8509 = cljs.core.rest(m);
var G__8510 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
